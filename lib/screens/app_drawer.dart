...
class AppMenuDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          _buildDrawerHeader(),
          _buildMenuItem(icon: Icons.account_circle, text: 'Akun', textStyle: textStyle, onTap: () {}),
          ...
          _buildMenuItem(icon: Icons.card_giftcard, text: 'Reward', textStyle: textStyle, onTap: () {}),
          _buildMenuItem(icon: Icons.settings, text: 'Pengaturan', textStyle: textStyle, onTap: () {}),
  ...
  Widget _buildMenuItem({required IconData icon, required String text, required TextStyle textStyle, required VoidCallback onTap}) {
    return ListTile(
